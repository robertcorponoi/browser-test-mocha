...
after(function (done) {
  ...
  fs.removeSync(path.resolve(__dirname, '../src/scripts'));
...
describe('browser-test-mocha CLI', () => {
  ...
  it('should create the correct project structure', function (done) {
    ...
    shell.exec('node cli/browser-test-mocha.js test/scripts/1.js,test/scripts/2.js,test/scripts/3.js', { async: true });
    ...
    setTimeout(() => {
      ...
      chai.expect(src).to.deep.equal(['1.js', '2.js', '3.js']) && chai.expect(index.length).to.equal(797);
